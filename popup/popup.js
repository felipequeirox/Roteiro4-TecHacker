// Quando o popup abre, pega a aba ativa e solicita os dados ao background
...
function renderThirdParties(data) {
  ...
  // Ordena por tipo e depois por domínio
...
/** Escapa HTML para evitar XSS ao inserir dados externos no DOM */
